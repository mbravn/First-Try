...
{   
    ...
    TESTDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"TESTDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(TESTDataViewController *)viewController];
